...
var Ritare = {
	...
	start: function(options) {
		...
		$('#picker').attr('value','#FF0000');
		this.picker.addEventListener('change', (function(color){
			alert(color);
		...
		this.finishbutton.className = 'btn btn-success btn-large';
		this.finishbutton.type = 'button';
		this.finishbutton.innerHTML = '<i class="glyphicon glyphicon-pencil"></i> Post';
